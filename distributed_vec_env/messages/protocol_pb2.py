...
_MASTERRESPONSE_CONFIRMATIONRESPONSEENUM = _descriptor.EnumDescriptor(
  ...
  values=[
    ...
    _descriptor.EnumValueDescriptor(
      ...
      type=None),
    _descriptor.EnumValueDescriptor(
      name='OK_ENCOURAGE', index=5, number=5,
      options=None,
      type=None),
  ],
  containing_type=None,
...
_WORKERCOMMAND_WORKERCOMMANDENUM = _descriptor.EnumDescriptor(
  ...
  values=[
    ...
    _descriptor.EnumValueDescriptor(
      ...
      type=None),
    _descriptor.EnumValueDescriptor(
      name='WAKE_UP', index=4, number=4,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='RESET_CLIENT', index=5, number=5,
      options=None,
      type=None),
  ],
  containing_type=None,
...
_NAMERESPONSE = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='reset_compensation', full_name='NameResponse.reset_compensation', index=5,
...
_WORKERCOMMAND = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='instance_id', full_name='WorkerCommand.instance_id', index=3,
